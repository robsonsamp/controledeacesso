...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide your session key for Controle de Acesso.
    |
    */

    'session' => 'xfusionsolution_controledeacesso',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide your cookie key for Controle de Acesso.
    |
    */

    'cookie' => 'xfusionsolution_controledeacesso',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the user model used in Controle de Acesso.
    |
    */

    'usuarios' => [

        'model' => 'Xfusionsolution\Controledeacesso\Usuarios\ModelUsuario',
    ...
    |--------------------------------------------------------------------------
    |
    | Please provide the role model used in Controle de Acesso.
    |
    */

    'perfis' => [

        'model' => 'Xfusionsolution\Controledeacesso\Permissoes\Perfis\ModelPerfil',
    ...
    */
    ...
    'funcionalidades' => [
        ...
        'model' => 'Xfusionsolution\Controledeacesso\Funcionalidades\ModelFuncionalidades',
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the permissoes class. Controle de Acesso ships with two
    | permission types.
    |
    | 'Xfusionsolution\Controledeacesso\Permissoes\StandardPermissoes'
    | 'Xfusionsolution\Controledeacesso\Permissoes\StrictPermissoes'
    |
    | "StandardPermissoes" will assign a higher priority to the user
    | permissoes over role permissoes, once a user is allowed or denied
    | a specific permission, it will be used regardless of the
    | permissoes set on the role.
    |
    | "StrictPermissoes" will deny any permission as soon as it finds it
    ...
    */
    ...
    'permissoes' => [
        ...
        'class' => 'Xfusionsolution\Controledeacesso\Permissoes\StandardPermissoes',
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may specify the persistencias model used and weather to use the
    | single persistencia mode.
    |
    */

    'persistencias' => [

        'model' => 'Xfusionsolution\Controledeacesso\Persistencias\ModelPersistencia',
    ...
    */
    ...
    'activations' => [
        ...
        'model' => 'Xfusionsolution\Controledeacesso\Activations\ModelActivation',
    ...
    */
    ...
    'reminders' => [
        ...
        'model' => 'Xfusionsolution\Controledeacesso\Reminders\ModelReminder',
